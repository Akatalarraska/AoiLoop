...
<https://github.com/Akatalarraska/DT1FLOW/security/advisories/new>
...
DT1FLOW stores information about a chronic condition on a personal device.
Anything that could expose that data, or corrupt a user's record of it, is in
scope — for example:

- another app on the device reading DT1FLOW's database
