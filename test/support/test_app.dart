import 'package:blauloop/app/app.dart';
...
import 'package:blauloop/core/utils/ticker.dart';
...
Future<AppUnderTest> pumpApp(
  ...
  await tester.pumpWidget(
    UncontrolledProviderScope(container: container, child: const BlauLoopApp()),
  );
