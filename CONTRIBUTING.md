...
Read the **medical boundaries** in the [README](README.md). BlauLoop does not
...
**Tests for logic that computes dates.** This is where BlauLoop's real risk
